...
{
  _i2cPort = &wirePort;
  // PATCHED: Do NOT call _i2cPort->begin() here — the caller already
  // configured the bus with the correct pins and clock speed.
  // The stock library call destroys custom pin assignments on ESP32.
